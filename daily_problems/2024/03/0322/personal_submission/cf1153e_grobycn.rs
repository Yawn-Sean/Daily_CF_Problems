...
fn solver(n: i32, scanner: &mut Scanner) -> impl Printable {
    let mut ask = |xmin: i32, ymin: i32, xmax: i32, ymax: i32| {
        println!("? {xmin} {ymin} {xmax} {ymax}");
        i32::from_scanner(scanner)
    };
