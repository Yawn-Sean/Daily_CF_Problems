...
| 2100 | [CF909D](https://codeforces.com/problemset/problem/909/D) | If we can finish each operation in $\mathcal{O}(1)$ time, we will be able to solve the problem. | TBD |